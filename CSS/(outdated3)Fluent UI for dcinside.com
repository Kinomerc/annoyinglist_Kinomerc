...
/* 방해 요소 */
 /* 갤러리, 마이너갤, 미니갤, 인물갤... 네비게이션 바 
div[class="gnb_bar"] {
    display:none;
}
/* 실시간 베스트 
section[class="left_content"] div[class="time_best"] {
    display:none;
}
/* 뉴스 */
section[class="left_content"] div[class$="news_con"] {
    display:none;
}
/* 개념글 */
section[class="left_content"] div[class$="concept_con"] {
    display:none;
}
/* 실북갤, 흥한갤 랭킹 
section[class="right_content"] div[class="content_box tab"] { 
    display:none;
}   
/* 디시트랜드 */
section[class="right_content"] div[class="content_box"] { 
    display:none;
}   
/* 트랜드 투표 */
section[class="right_content"] div[class="rightbanner"] { 
    display:none;
}   
/* 신설갤 */  
section[class="right_content"] div[class$="new_gall"] { 
    display:none;
}  
/* 디시미디어 */  
section[class="right_content"] div[class$="dcmedia"] { 
    display:none;
} 
/*  광고 */
section[class="right_content"] div[class="rightbanner1"] {
    display:none;
}
/*  실시간 베스트 */
section[class="right_content"] div[class$="r_timebest"] {
    display:none;
}
/*  개념글 */
section[class="right_content"] div[class$="r_recommend"] {
    display:none;
}
/*  디시트랜드 */
div[class="gallview_contents"] div[class$="dctrend_ranking"] {
    display:none;
}
/* 댓글돌이 */
li[id="comment_li_0"] {
...
@font-face {
    ...
    src:url('https://cdnjs.cloudflare.com/ajax/libs/pretendard-jp/1.3.9/variable/woff2/PretendardJPVariable.woff2') format('woff2');font-weight:400; 
}

body, div[class="top_search clear"] div[class="inner_search"] input::placeholder, button[class="tab_btn best main_tab_real_time_best on"], button[class="tab_btn light main_tab_real_time_best on"],button[class="btn_rank btn_dcbest_rank_tab"], div[class="fr"] a[class="contgo"], div[class="fr"] button[class="btn_cmt_refresh"], div[class="fr"] button[class="btn_cmt_close"] span,    div[class="cmt_inner"] a[class="contgo"], div[class="cmt_inner"] button[class="btn_cmt_refresh"], div[class="cmt_inner"] button[class="btn_cmt_close"] span, div[class="user_info_input"] input[placeholder="코드 입력"] div[class="user_info_input nomem_nick"], textarea[id^="memo_"], input[name="gall_nick_name"], input[name="password"], a[class="lnk"]{
    font-family:'PretendardJP-Variable';
}
*:not([class^="fa"], [class*=" fa-"], [role*="button"], [role="presentation"], [class*="icon"], [class*=" icon-"]) {
...
div[class="top_search clear"] div[class="inner_search"] {
    background-color:rgba(0, 0, 0, 0);
}
div[class="top_search clear"] div[class="inner_search"] input[class="in_keyword"] {
    border-radius:10px 0 0 10px;
}
/* 최상단 "갤러리 & 통합검색" 검색창의 버튼 */
div[class="top_search clear"] button[id="searchSubmit"]  {
    border-radius:10px;margin:1.5px 0 0px 0;transform:scale(0.8);transition:background-color 0.15s, box-shadow 0.15s;
}
div[class="top_search clear"] button[id="searchSubmit"]  :hover {
    box-shadow:0 4px 8px rgba(59, 72, 144);
}
/* 최상단 "갤러리 & 통합검색" 검색창의 검색목록창 */
div[class="auto_wordwrap"] {
    background-color: rgba(255, 255, 255, 0.3);
    backdrop-filter:blur(10px);border:0px solid rgba(0, 0, 0, 0);border-radius:10px;box-shadow:0 2px 4px rgba(128, 128, 128, 0.1);margin-top:8px;transition:border-color 0.15s, box-shadow 0.15s;
}
div[class="auto_wordwrap"]:hover {
    box-shadow:0 4px 8px rgba(128, 128, 128, 0.2);
}  
/* 최상단 "갤러리 & 통합검색" 검색창의 검색목록창의 검색목록의 갤러리 xx건 */
div[class="auto_wordwrap"] div[class="auto_word"] div[class="word_box"] h3[class="word_tit"] {
    border-radius:10px;
    background-color: rgba(255, 255, 255, 0.3);
    backdrop-filter: blur(10px) ;
    margin:8px;color:#F3F4F8;
...
/* 최상단 "갤러리 & 통합검색" 검색창의 검색목록창의 검색목록의 갤러리 xx건 더보기 > */
div[class="auto_wordwrap"] div[class="auto_word"] div[class="word_box"] h3[class="word_tit"] a {
    margin:0  8px 0 0;color:#F3F4F8;
}
/* 최상단 "갤러리 & 통합검색" 검색창의 검색목록창의 검색목록글씨 */
div[class="auto_wordwrap"] div[class="auto_word"] div[class="word_box"] ul[class="word_list"] {
    margin-left:10px;margin-right:10px;transition:border-color 0.15s, box-shadow 0.15s;
}   
/* 최상단 "갤러리 & 통합검색" 검색창의 검색목록창의 하단 닫기탭 */
div[class="auto_wordwrap"] div[class="auto_word"] div[class="word_box"] div[class="word_close"] {
    border:none;
    border-radius:0 0 10px 10px;
    box-shadow:0 2px 4px rgba(128, 128, 128, 0.1);
    transition:border-color 0.15s, box-shadow 0.15s;
}
div[class="auto_wordwrap"] div[class="auto_word"] div[class="word_box"] li[class="search_key"] {
    transition:background-color 0.15s;
    border-radius: 10px ;
}
div[class="auto_wordwrap"] div[class="auto_word"] div[class="word_box"] li[class="search_key"]:hover {
...
div[class="gnb_bar"] {
    border:1px solid rgba(0, 0, 0, 0.1);box-shadow:0 1px 3px rgba(128, 128, 128, 0.3);
}
div[class="gnb_bar"]:hover {
    box-shadow:0 4px 8px rgba(128, 128, 128, 0.2);transition:border-color 0.15s, box-shadow 0.15s;
}
a[href="https://gall.dcinside.com"] {
    border-radius:5px;text-decoration:none; 
    transition:background-color 0.15s, box-shadow 0.15s, color 0.15s ease;
}
a[href="https://gall.dcinside.com"]:hover {
    text-decoration:none;color:rgba(255, 237, 68, .9);
}
...
div[id="visit_history"] {
    margin-top:10px; 
    border:none;transition:background-color 0.15s, box-shadow 0.15s;
}
 /* 최근방문 첫페이지 문제 있음? */
div[class="newvisit_history vst"]:hover {
    box-shadow:0 2px 4px rgba(128, 128, 128, 0.3);
}
div[class="newvisit_history vst"] { 
    background-color:rgba(255, 255, 255, 0.3);border-top:1px solid #d5d5d5;border-left:none;border-right:none;border-bottom:none;box-shadow:0 1px 3px rgba(128, 128, 128, 0.3);transition:background-color 0.15s, box-shadow 0.15s;
}
li[class^="lately_gall_"]  {
    border-radius:5px;text-decoration:none; 
    transition: background-color 0.15s, box-shadow 0.15s, color 0.15s, padding 0.15s ease;
}
li[class^="lately_gall_"]:hover {
...
button[class="bnt_newvisit_more"] {
    color:rgba(202, 203, 251);text-decoration:none; 
    transition:color 0.15s ease;
}
button[class="bnt_newvisit_more"]:hover {
    text-decoration:none; 
    color:rgba(202, 203, 251, .9);
}

/* 최근방문 ↓ 아이콘 */
em[class="sp_img icon_listmore"] {
    background-color:rgba(255, 255, 255, 0.3);border-radius:10px;box-shadow:0 1px 3px rgba(128, 128, 128, 0.3);transition:background-color 0.15s, box-shadow 0.15s;
}
em[class="sp_img icon_listmore"]:hover {
    background-color:rgba(255, 255, 255, 0.3);box-shadow:0 4px 8px rgba(, 0.2);
}

/* 최근방문 ↓ 선택시 나오는 창 */
div[class="pop_wrap gray1px"]{
    background-color:rgba(255, 255, 255, .3);backdrop-filter:blur(10px);border:1px solid rgba(0, 0, 0, 0.1);border-radius:10px;box-shadow:0 1px 3px rgba(128, 128, 128, 0.3);transition:background-color 0.15s, box-shadow 0.15s;margin-top:10px;
}
...
div[class="time_best"] li {
    border: none !important;
    border-radius: 10px !important;
}
div[class="time_best"] li span {
    border: none !important;
...
.checkbox input[type="checkbox"]:checked + .checkmark:after {
 ...
 /* 알림 */
div[id="alarmList"] {
    background-color:rgba(255, 255, 255, 0.3);backdrop-filter:blur(10px);border:0px solid rgba(0, 0, 0, 0.1)!important;
    border-radius:10px;box-shadow:0 1px 3px rgba(128, 128, 128, 0.3);transition:background-color 0.15s, box-shadow 0.15s;margin-top:10px;
}
div[id="alarmList"]:hover {
    background-color:rgba(255, 255, 255, 0.3);box-shadow:0 4px 8px rgba(128, 128, 128, 0.2);
}
em[class="sp_img icon_bgblueclose"] {
    border-radius:50%;transform:translate(-6px, 8px) scale(0.75); 
}
/* 우하단 댓글 알림 */
...
div[class^="alarmPopup"]:hover {
    background-color:rgba(255, 255, 255, 0.3) ;box-shadow:0 4px 10px rgba(128, 128, 128, .3) ;
}
...
{
    transform:translateX(6px) translateY(0px) ;transition:color 0.15s ;
}

em[class="sp_img icon_bword_del"] {
    background-color:rgba(255, 255, 255, 0.3);border-radius:10px;box-shadow:0 1px 3px rgba(128, 128, 128, 0.3);transition:background-color 0.15s, box-shadow 0.15s;transform:translateY(-1px);
}
span[class="new"] {
    display:none;
}
div[class="refresher-toast"] {
    background-color:rgba(255, 255, 255, 0.3);backdrop-filter:blur(10px);border:2px solid rgba(0, 0, 0, 0.1);border-radius:10px;box-shadow:0 1px 3px rgba(128, 128, 128, 0.3);transition:background-color 0.15s, box-shadow 0.15s;
}
...
/* 실북 흥한갤 */
section[class="right_content"] div[class="content_box tab"]{
    border:1px solid rgba(0, 0, 0, 0.1);border-radius:10px;box-shadow:0 1px 3px rgba(128, 128, 128, 0.3);transition:background-color 0.15s, box-shadow 0.15s;
}
section[class="right_content"] div[class="content_box tab"]:hover {
    box-shadow:0 4px 8px rgba(128, 128, 128, 0.2);
}
ol[class^="rank_list gall g_"] a{
    border-radius:5px;    text-decoration:none; 
    transition:background-color 0.15s, box-shadow 0.15s, color 0.15s ease;
}
ol[class^="rank_list gall g_"] a:hover {
    text-decoration:none;
    color:rgba(59, 72, 144, .9)!important;
}
ol[class^="rank_list mgall m_"] a{
    text-decoration:none; 
    transition:background-color 0.15s, box-shadow 0.15s, color 0.15s ease;
}
ol[class^="rank_list mgall m_"] a:hover {
    text-decoration:none;color:rgba(255, 102, 0, .9)!important;
}
ol[class^="rank_list minigall mi_"] a{
    text-decoration:none; 
    transition:background-color 0.15s, box-shadow 0.15s, color 0.15s ease;
}
ol[class^="rank_list minigall mi_"] a:hover {
    text-decoration:none;color:rgba(111, 109, 217, .9)!important;
}
ol[class^="rank_list persongall pr_"] a{
    text-decoration:none; 
    transition:background-color 0.15s, box-shadow 0.15s, color 0.15s ease;
}
ol[class^="rank_list persongall pr_"] a:hover {
    text-decoration:none;
...
a[section_code="main_minor_count"] span[class="rank_txt"]:hover {
    padding:4px;background-color:rgba(255, 255, 255, 0.3);box-shadow:0 4px 8px rgba(128, 128, 128, 0.2);display:inline-block;position:relative;left:-1px; 
...
a[section_code="main_count"] span[class="rank_txt"]:hover {
    padding:4px;background-color:rgba(255, 255, 255, 0.3);box-shadow:0 4px 8px rgba(128, 128, 128, 0.2);display:inline-block;position:relative;left:12px; 
    top:-18px;text-decoration:none;
}
*/
/* 메인하단 footer */
